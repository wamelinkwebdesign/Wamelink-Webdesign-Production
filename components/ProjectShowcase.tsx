...
const projects: ProjectData[] = [
  ...
  },
  {
    ...
    challenge: 'Bouwbedrijf DW verenigt design en uitvoering om unieke woon- en werkplekken te creëren, met een passie voor monumenten en herenhuizen. Hun expertise in architectuur, renovatie en interieurontwerp had een online platform nodig dat diezelfde kwaliteit uitstraalt.',
    solution: 'Een website gebouwd die de ambachtelijke aanpak van Bouwbedrijf DW weerspiegelt. Door hun projecten in architectuur, renovatie en interieurontwerp centraal te zetten, straalt de site direct het vakmanschap en de ontwerpvisie uit waarmee zij monumenten en herenhuizen tot leven brengen.',
