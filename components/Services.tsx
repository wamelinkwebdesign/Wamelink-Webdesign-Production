...
import { Globe, RefreshCw, ShoppingBag, Smartphone, Plus, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4">
             ...
             >
               ...
               <p className="text-xl font-medium text-gray-500 max-w-sm leading-relaxed">
                  Geen templates. Geen half werk. <br />Ik ontwerp en bouw digitale ervaringen die je merk versterken en verschil maken. Van concept tot lancering, volledige ontzorging.
               </p>
             </motion.div>
          </div>
          ...
          >
            ...
            {/* Website Laten Maken Card */}
            <motion.div
              variants={cardVariants}
              whileHover={{ scale: 0.98 }}
              className="bg-white p-8 border border-black rounded-3xl flex flex-col justify-between hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-shadow duration-300 will-change-transform cursor-hover"
            >
              <div>
                ...
                <ul className="space-y-4">
                  {[
                    'Volledig maatwerk design & development',
                    'SEO-geoptimaliseerd vanaf dag een',
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <Link to="/website-laten-maken-amsterdam" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest hover:text-[#FFD700] transition-colors">
                  Meer info <ArrowRight size={16} strokeWidth={3} />
                </Link>
              </div>
            </motion.div>
            ...
            <motion.div
              variants={cardVariants}
              whileHover={{ scale: 0.98 }}
              className="bg-black text-white p-8 border border-black rounded-3xl flex flex-col justify-between hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,0.3)] transition-shadow duration-300 will-change-transform cursor-hover"
            >
              <div>
              ...
              <div className="mt-8 pt-8 border-t border-white/20">
                <Link to="/website-redesign-amsterdam" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest hover:text-[#FFD700] transition-colors">
                  Meer info <ArrowRight size={16} strokeWidth={3} />
                </Link>
              </div>
            </motion.div>
            ...
            <motion.div
              variants={cardVariants}
              whileHover={{ scale: 0.98 }}
              className="bg-[#FFD700] p-8 border border-black rounded-3xl flex flex-col justify-between hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-shadow duration-300 will-change-transform cursor-hover"
            >
              <div>
                ...
                <motion.h3 variants={itemVariants} className="text-3xl font-bold mb-2 tracking-tight">Webshop</motion.h3>
                <motion.p variants={itemVariants} className="text-lg font-bold mb-6 opacity-80">E-commerce die verkoopt.</motion.p>
                <ul className="space-y-4">
                  {[
                    'Conversie-geoptimaliseerd design',
                    'Alle betaalmethodes inbegrepen',
                    'SEO voor Google Shopping',
                    'Voorraadbeheer & integraties'
                  ].map((item, i) => (
                    <motion.li key={i} variants={itemVariants} className="flex items-center gap-3 text-lg font-bold">
              ...
              <div className="mt-8 pt-8 border-t border-black/20">
                <Link to="/webshop-laten-maken-amsterdam" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest hover:text-white transition-colors">
                  Meer info <ArrowRight size={16} strokeWidth={3} />
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <Link to="/app-laten-maken-amsterdam" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest hover:text-[#FFD700] transition-colors">
                  Meer info <ArrowRight size={16} strokeWidth={3} />
                </Link>
              </div>
            </motion.div>
